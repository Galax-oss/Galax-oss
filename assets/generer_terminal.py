...
SESSION = [
    ("commande", "whoami"),
    ("sortie", [(COMMANDE, "Victor Norture"), (SORTIE_TEXTE, " - cybersecurite et reseaux")]),
    ("sortie", [(SORTIE_TEXTE, "Bachelor 3, EFREI Paris - Ile-de-France")]),
    ("vide", None),

    ("commande", "cat objectif.txt"),
    ("sortie", [(SORTIE_TEXTE, "Alternance "), (COMMANDE, "2026-2027"),
                (SORTIE_TEXTE, " - administration systemes et reseaux,")]),
    ("sortie", [(SORTIE_TEXTE, "securite operationnelle, gestion des vulnerabilites")]),
    ("sortie", [(SORTIE_TEXTE, "Rythme  "), (COMMANDE, "1 semaine de formation / 2 semaines en entreprise")]),
    ("sortie", [(SORTIE_TEXTE, "Base    "), (COMMANDE, "Ile-de-France"), (SORTIE_TEXTE, ", vehicule")]),
    ("sortie", [(SORTIE_TEXTE, "Certifie "), (ORANGE, "Microsoft Azure AZ-900")]),
    ("vide", None),

    ("commande", "ls -1 projets/"),
    ("projet", ("kev-triage", "238 vulnerabilites ramenees a 14 a traiter")),
    ("projet", ("ios-config-audit", "16 ecarts sur une configuration d'usine")),
    ("projet", ("azure-sftp-lab", "10 controles de securite apres deploiement")),
    ("projet", ("linux-hardening-audit", "18 regles, sshd_config et sysctl")),
    ("projet", ("authlog-watch", "4 alertes, la compromission en tete")),
    ("projet", ("veille-certfr", "100 avis par mois ramenes a 3 lignes utiles")),
    ("vide", None),
