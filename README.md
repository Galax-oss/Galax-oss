...
| | | |
|---|---|---|
| [**kev-triage**](https://github.com/Galax-oss/kev-triage) | Trie les vulnérabilités par risque réel, en croisant OSV, EPSS et le catalogue KEV de la CISA | 238 trouvées, **14 à traiter** |
| [**ios-config-audit**](https://github.com/Galax-oss/ios-config-audit) | Audite une configuration Cisco IOS contre 16 règles de durcissement | **16 écarts sur 16** en sortie d'usine |
| [**linux-hardening-audit**](https://github.com/Galax-oss/linux-hardening-audit) | Contrôle un `sshd_config` et un état `sysctl` | **18 règles** |
| [**authlog-watch**](https://github.com/Galax-oss/authlog-watch) | Détecte force brute, pulvérisation et compromission dans un `auth.log` | la compromission **en tête** |
